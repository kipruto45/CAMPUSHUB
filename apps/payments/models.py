...
class Plan(TimeStampedModel):
    ...
    upload_limit_monthly = models.IntegerField(default=10)
    message_limit_daily = models.IntegerField(default=20)
    group_limit = models.IntegerField(default=3)
    bookmark_limit = models.IntegerField(default=20)
    event_limit_monthly = models.IntegerField(default=10)
    points_limit_monthly = models.IntegerField(default=500)
    badge_limit = models.IntegerField(default=5)
    search_results_limit = models.IntegerField(default=10)
    notification_delay_hours = models.IntegerField(default=1)
    support_response_hours = models.IntegerField(default=48)
