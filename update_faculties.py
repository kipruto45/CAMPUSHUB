#!/usr/bin/env python3
"""
Script to update faculties, departments, and courses in the CampusHub database.
Run this script to update the dashboard with the new structure.
"""
...
def update_faculties():
    """Update faculties, departments, and courses."""
    
    # Clear existing data
    print("Clearing existing faculties, departments, and courses...")
    ...
    print("SUMMARY")
    print("="*60)
    print(f"Faculties created: {Faculty.objects.count()}")
    print(f"Departments created: {Department.objects.count()}")
